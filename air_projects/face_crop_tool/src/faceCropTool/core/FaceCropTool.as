	...
	public class FaceCropTool extends Sprite {
		...
		private function updateFaceCrop():void {
			...
			for each (var image:FaceImage in State.images) {
				...
				image.cropBitmapOverlay.bitmapData = BitmapUtil.scaleDataToFill(image.cropBitmapOverlay.bitmapData, image.cropBitmap.bitmapData.width, image.cropBitmap.bitmapData.height);
