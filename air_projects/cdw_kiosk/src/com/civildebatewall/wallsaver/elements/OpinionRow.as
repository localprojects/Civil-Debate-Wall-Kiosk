package com.civildebatewall.wallsaver.elements {
	...
	public class OpinionRow extends Sprite {
		...
		public function calculateFrames(vxIntro:Number, vxMiddle:Number, vxOutro:Number, easeIntroFrames:int, easeOutroFrames:int, targetFrameCount:int = -1):void {
			...
			introFrameCount = CivilDebateWall.flashSpan.settings.totalWidth / vxIntro;
			outroFrameCount = CivilDebateWall.flashSpan.settings.totalWidth / vxOutro;			
			...
			tempX = (-this.width - CivilDebateWall.flashSpan.settings.screenWidth) - vxIntro; // a little off-screen padding
			...
			tempX = CivilDebateWall.flashSpan.settings.totalWidth + vxOutro; // a little off-screen padding
