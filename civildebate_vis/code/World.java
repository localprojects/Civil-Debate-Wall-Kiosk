...
public class World
{
      ...
      for(int i = 0; i < NUM_ANSWERS; i++)
      {
       ...
       //  }
        ...
        // {
            ...
            {
               Shape s = new Shape(new PVector(canvas.random((i-1)*300 - 150, (i-1)*300 + 150), 0, canvas.random(-400, 0)), 
   ...
   public static void draw(PApplet canvas, DbData data)
   {
      ...
      canvas.perspective(canvas.PI/2.0f, (int)(canvas.width/canvas.height), 1.0f, 10000.0f) ;
